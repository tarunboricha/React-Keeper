...
const HomeScreen = (props) => {
    ...
    useEffect(() => {
        ...
        if (user) {
            ...
            setUserid(user);
            const url = `https://3c31-103-250-162-221.ngrok-free.app/notes/${user}`;
    ...
    function addNote() {
        if (userid) {
            ...
            const url = "https://3c31-103-250-162-221.ngrok-free.app/notes";
    ...
    function loadnotes() {
        setNotes([]);
        setisSpinner(true);
        const url = `https://3c31-103-250-162-221.ngrok-free.app/notes/${userid}`;
    ...
    const deleteNote = (id) => {
        if (userid) {
            setisSpinner(true);
            setNotes([]);
            const url = "https://3c31-103-250-162-221.ngrok-free.app/notes/" + id;
